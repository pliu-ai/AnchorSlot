...
from .dataloader_structured_conditional_no_slot3_er_in_cond_slot import StructuredConditionalDataLoader3D
from .inference_structured_conditional_no_slot3_er_in_cond_slot import (
    predict_logits_all_groups,
    predict_logits_for_group,
    reconstruct_original_labels_from_all_groups,
)
from .label_mapping_no_slot3_er_in_cond_slot import (
    NUM_DYNAMIC_GROUPS,
    NUM_OUTPUT_CHANNELS,
...
from .metrics_structured_conditional_no_slot3_er_in_cond_slot import (
...
class nnUNetTrainerStructuredConditionalNoSlot3ERInCondSlot(nnUNetTrainer):
    """
    ...
    def on_train_start(self):
        ...
        self.print_to_log_file(
            "[StructuredConditionalERInCondSlot] "
