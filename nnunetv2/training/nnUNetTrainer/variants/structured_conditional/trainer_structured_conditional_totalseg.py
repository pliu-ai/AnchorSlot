...
from .dataloader_structured_conditional_totalseg import StructuredConditionalDataLoader3D
from .inference_structured_conditional_totalseg import (
    predict_logits_all_groups,
    predict_logits_for_group,
    reconstruct_original_labels_from_all_groups,
)
from .label_mapping_totalseg import (
    NUM_DYNAMIC_GROUPS,
    NUM_OUTPUT_CHANNELS,
...
from .metrics_structured_conditional_totalseg import (
...
from .structured_loss_totalseg import StructuredConditionalLoss, StructuredLossConfig


class nnUNetTrainerStructuredConditionalTotalSeg(nnUNetTrainer):
    """
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        # multi-group inference + reconstruction (inference_structured_conditional_totalseg).
        self.print_to_log_file(
            "[AnchorSlot-TotalSeg] Skipping nnU-Net flat perform_actual_validation "
