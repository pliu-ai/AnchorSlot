...
from .dataloader_structured_conditional_no_slot3_er_dynamic import StructuredConditionalDataLoader3D
from .inference_structured_conditional_no_slot3_er_dynamic_slot_assignment import (
    predict_logits_all_groups,
    predict_logits_for_group,
    reconstruct_original_labels_from_all_groups,
)
from .label_mapping_no_slot3_er_dynamic_slot_assignment import (
    NUM_DYNAMIC_GROUPS,
    NUM_OUTPUT_CHANNELS,
    SLOT_ASSIGNMENT_POLICY,
    SLOT_ASSIGNMENT_RANDOM_SEED,
    get_slot_assignment_report,
    infer_present_groups_from_segmentation,
    original_label_name_lookup,
    remap_original_to_structured,
    sample_group_id_for_case,
)
from .metrics_structured_conditional_no_slot3_er_dynamic_slot_assignment import (
...
from .structured_loss_no_slot3_er_dynamic import StructuredConditionalLoss, StructuredLossConfig


class nnUNetTrainerStructuredConditionalNoSlot3ERDynamicSlotAssignment(nnUNetTrainer):
    """
    Structured conditional trainer for CellMap with ER membrane/lumen as dynamic-only labels:
    - one shared model
    ...
    def __init__(
        ...
        self.slot_assignment_policy = SLOT_ASSIGNMENT_POLICY
        self.slot_assignment_random_seed = SLOT_ASSIGNMENT_RANDOM_SEED
        self.slot_assignment_report = get_slot_assignment_report()
        ...
        # Optional val-iteration override for this trainer only.
        ...
        self.val_groups_per_epoch = int(os.environ.get("NNUNET_STRUCTCOND_VAL_GROUPS_PER_EPOCH", str(self.num_dynamic_groups)))
    ...
    def _setup_wandb(self) -> None:
        ...
        run = wandb.init(
            ...
            config={
                ...
                "slot_assignment_random_seed": self.slot_assignment_random_seed,
    ...
    def on_train_start(self):
        ...
        self.print_to_log_file(
            "[StructuredConditionalERDynamicSlotAssignment] "
            ...
            f"slot_assignment_policy={self.slot_assignment_policy}, "
            f"slot_assignment_random_seed={self.slot_assignment_random_seed}, "
        ...
        self.print_to_log_file(
            "[StructuredConditionalERDynamicSlotAssignment][slot_map] "
            + json.dumps(self.slot_assignment_report, sort_keys=True)
        )
