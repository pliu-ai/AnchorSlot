...
from .dataloader_structured_conditional_no_slot3_minimal_anchors import StructuredConditionalDataLoader3D
from .inference_structured_conditional_no_slot3_minimal_anchors import (
    predict_logits_all_groups,
    predict_logits_for_group,
    reconstruct_original_labels_from_all_groups,
)
from .label_mapping_no_slot3_minimal_anchors import (
    NUM_DYNAMIC_GROUPS,
    NUM_OUTPUT_CHANNELS,
...
from .metrics_structured_conditional_no_slot3_minimal_anchors import (
...
from .structured_loss_no_slot3_minimal_anchors import StructuredConditionalLoss, StructuredLossConfig


class nnUNetTrainerStructuredConditionalNoSlot3MinimalAnchors(nnUNetTrainer):
    """
    Structured conditional trainer for the minimal-anchor CellMap ablation:
    - one shared model
    - fixed 7-channel output head
    - fixed anchors are ecs, pm, and cyto only
    ...
    def on_train_start(self):
        ...
        self.print_to_log_file(
            "[StructuredConditionalMinimalAnchors] "
