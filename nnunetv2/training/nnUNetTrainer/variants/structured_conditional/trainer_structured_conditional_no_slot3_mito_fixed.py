...
from .dataloader_structured_conditional_no_slot3_mito_fixed import StructuredConditionalDataLoader3D
from .inference_structured_conditional_no_slot3_mito_fixed import (
    predict_logits_all_groups,
    predict_logits_for_group,
    reconstruct_original_labels_from_all_groups,
)
from .label_mapping_no_slot3_mito_fixed import (
    NUM_DYNAMIC_GROUPS,
    NUM_OUTPUT_CHANNELS,
...
from .metrics_structured_conditional_no_slot3_mito_fixed import (
...
class nnUNetTrainerStructuredConditionalNoSlot3MitoFixed(nnUNetTrainer):
    """
    ...
    def on_train_start(self):
        ...
        self.print_to_log_file(
            "[StructuredConditionalMitoFixed] "
    ...
    def on_train_epoch_end(self, train_outputs: List[dict]):
        ...
        self.print_to_log_file(
            "[StructuredConditionalMitoFixed] train group sample counts this epoch: "
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        self.print_to_log_file("[StructuredConditionalMitoFixed][val] " + json.dumps(report["summary"], sort_keys=True))
