...
# Fixed original TotalSegmentator labels: liver=5, spleen=1, aorta=52, heart=51.
...
def compute_group_confusion_from_logits(
    ...
    active_eval_channels = [LIVER_CHANNEL, SPLEEN_CHANNEL, AORTA_CHANNEL, HEART_CHANNEL]
