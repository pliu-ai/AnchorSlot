...
from . import label_mapping_synapse_no_slot3 as label_mapping
...
class nnUNetTrainerStructuredConditionalSynapseNoSlot3(base.nnUNetTrainerStructuredConditionalSynapse):
    def __init__(
        self,
        plans: dict,
        configuration: str,
