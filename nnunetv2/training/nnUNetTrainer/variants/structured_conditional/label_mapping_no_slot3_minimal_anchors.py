...
# Fixed output head channels for the minimal-anchor ablation.
BACKGROUND_CHANNEL = 0
ECS_CHANNEL = 1
PM_CHANNEL = 2
CYTO_CHANNEL = 3
COND_SLOT_1_CHANNEL = 4
COND_SLOT_2_CHANNEL = 5
OTHER_CHANNEL = 6
NUM_OUTPUT_CHANNELS = 7
NUM_DYNAMIC_GROUPS = 15
...
DYNAMIC_GROUP_SPECS: Tuple[DynamicGroupSpec, ...] = (
    ...
    DynamicGroupSpec(1, "G2", "MitoRibo", (6,), ("mito_ribo",)),
    DynamicGroupSpec(2, "G3", "Golgi", (7, 8), ("golgi_mem", "golgi_lum")),
    DynamicGroupSpec(3, "G4", "Vesicle", (9, 10), ("ves_mem", "ves_lum")),
    DynamicGroupSpec(4, "G5", "Endosome", (11, 12), ("endo_mem", "endo_lum")),
    DynamicGroupSpec(5, "G6", "Lysosome", (13, 14), ("lyso_mem", "lyso_lum")),
    DynamicGroupSpec(6, "G7", "LipidDroplet", (15, 16), ("ld_mem", "ld_lum")),
    DynamicGroupSpec(7, "G8", "ER", (17, 18), ("er_mem", "er_lum")),
    DynamicGroupSpec(8, "G9", "ERES", (19, 20), ("eres_mem", "eres_lum")),
    DynamicGroupSpec(9, "G10", "NuclearEnvelope", (21, 22), ("ne_mem", "ne_lum")),
    DynamicGroupSpec(10, "G11", "NuclearPore", (23, 24), ("np_out", "np_in")),
    DynamicGroupSpec(11, "G12", "Chromatin", (25, 26), ("hchrom", "echrom")),
    DynamicGroupSpec(12, "G13", "Nucpl", (27,), ("nucpl",)),
    DynamicGroupSpec(13, "G14", "Microtubule", (28, 29), ("mt_out", "mt_in")),
    DynamicGroupSpec(14, "G15", "Peroxisome", (30, 31), ("perox_mem", "perox_lum")),
)
...
def remap_original_to_structured(
    ...
    """
    Remap original CellMap labels into the fixed 7-channel structured target space.

    Args:
        segmentation: [B, 1, ...] (or [B, ...]) tensor of original label IDs.
        group_ids: [B] dynamic group IDs in [0, 14].
        ignore_label: Optional dataset ignore label.

    Returns:
        remapped_target: [B, 1, ...], long, values in [0, 6] on valid voxels.
