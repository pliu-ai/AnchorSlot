...
from .inference_structured_conditional_no_slot3_er_dynamic import (
    predict_logits_all_groups,
    predict_logits_for_group,
    reconstruct_original_labels_from_all_groups,
)
from .label_mapping_no_slot3_er_dynamic import (
    NUM_DYNAMIC_GROUPS,
    NUM_OUTPUT_CHANNELS,
...
from .metrics_structured_conditional_no_slot3_er_dynamic import (
...
class nnUNetTrainerStructuredConditionalNoSlot3ERDynamic(nnUNetTrainer):
    """
    ...
    def on_train_start(self):
        ...
        self.print_to_log_file(
            "[StructuredConditionalERDynamic] "
