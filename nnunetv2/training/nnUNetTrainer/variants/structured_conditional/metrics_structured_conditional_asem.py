...
# ASEM all-conditional variant has NO fixed anchors.
FIXED_CHANNEL_NAME_MAP: Dict[int, str] = {}

# No fixed original labels in the all-conditional ASEM variant.
FIXED_ORIGINAL_LABEL_TO_CHANNEL: Dict[int, int] = {}
