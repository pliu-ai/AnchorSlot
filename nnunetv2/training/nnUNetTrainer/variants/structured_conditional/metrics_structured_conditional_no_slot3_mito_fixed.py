...
FIXED_CHANNEL_NAME_MAP = {
    ...
    PM_CHANNEL: "pm",
    CYTO_CHANNEL: "cyto",
    MITO_MEM_CHANNEL: "mito_mem",
    MITO_LUM_CHANNEL: "mito_lum",
    NUCPL_CHANNEL: "nucpl",
...
def compute_group_confusion_from_logits(
    ...
    active_eval_channels = [ECS_CHANNEL, PM_CHANNEL, CYTO_CHANNEL, MITO_MEM_CHANNEL, MITO_LUM_CHANNEL, NUCPL_CHANNEL, MITO_RIBO_CHANNEL]
