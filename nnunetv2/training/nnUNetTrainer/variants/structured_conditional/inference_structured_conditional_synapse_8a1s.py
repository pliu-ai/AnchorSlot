...
def predict_logits_all_groups(
    ...
    """Run all dynamic groups (0..12) and return logits by group ID."""
...
def predict_structured_labels_for_group(
    ...
    """Option A: predict structured 9-class labels for a selected dynamic group."""
...
def reconstruct_original_labels_from_all_groups(
    ...
    score_map = first_logits.new_full((b, NUM_ORIGINAL_LABELS, *spatial), fill_value=-1e4)
