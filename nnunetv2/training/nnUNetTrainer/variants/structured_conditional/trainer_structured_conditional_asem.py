...
from .dataloader_structured_conditional_asem import StructuredConditionalDataLoader3D
from .inference_structured_conditional_asem import (
    predict_logits_all_groups,
    predict_logits_for_group,
    reconstruct_original_labels_from_all_groups,
)
from .label_mapping_asem import (
    NUM_DYNAMIC_GROUPS,
    NUM_OUTPUT_CHANNELS,
...
from .metrics_structured_conditional_asem import (
...
from .structured_loss_asem import StructuredConditionalLoss, StructuredLossConfig


class nnUNetTrainerStructuredConditionalASEM(nnUNetTrainer):
    """
    ...
    def __init__(
        ...
        self.p_present_group = float(np.clip(float(os.environ.get("NNUNET_STRUCTCOND_P_PRESENT_GROUP", "1.0")), 0.0, 1.0))
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        if self.grad_scaler is not None:
            ...
            self._assert_all_finite(grad_norm, "gradient norm")
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        # multi-group inference + reconstruction (inference_structured_conditional_asem).
        self.print_to_log_file(
            "[AnchorSlot-ASEM] Skipping nnU-Net flat perform_actual_validation "
